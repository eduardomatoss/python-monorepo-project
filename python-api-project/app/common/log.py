...
def get_application_log_level():
    ...
    return app_log_level if app_log_level in ["CRITICAL", "ERROR", "WARNING", "INFO", "DEBUG", "NOTSET"] else "INFO"
...
class LogFormatter(Formatter):
    ...
    def format(self, record):
        ...
        if record.levelname == "ERROR" and record.exc_info is not None:
            lines = format_exception(record.exc_info[0], record.exc_info[1], record.exc_info[2])
